...
4. If the schema file exports types, confirm the `index.ts` (or barrel file) in `02-app/lib/db/schema/` exports the new table and types — add the export if missing.
